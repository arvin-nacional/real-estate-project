...
export const Loading: React.FC<LoadingProps> = ({ className = '', fullScreen = false }) => {
  return (
    <div
      className={`flex items-center justify-center ${fullScreen ? 'fixed inset-0 bg-white/90 z-50' : ''} ${className}`}
    >
